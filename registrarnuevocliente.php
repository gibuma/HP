...
<div class="container-fluid">
  <div class="row">
  <center>
    <form id="altaclientesform" action="php/altaclientes.php" name="altaclientesform" method="post" onsubmit="return validacion()">
      <p><h3>Cliente:</h3></p>
      <p>
        <label for="textfield">
        <label></label>
 ...
 <input name="Apellido" type="text" id="Apellido" >
  ...
  <input name="Nombre" type="text" id="Nombre">
      ...
      <p>
        ...
        <input type="text" name="Dni" id="Dni" value="Opcional">
        ...
        <input type="text" name="Cuentas" id="Cuentas" value="Opcional">
        <label for="textfield4">Otros datos:</label>
        <input type="text" name="Otros" id="Otros" value="Opcional">
      </p>
      <p>&nbsp;</p>
      <p>
        <input type="submit" href="php/altaclientes.php" name="Agregar" id="Agregar" value="Agregar">
