...
<div class="container-fluid">
  ...
  <hr>
  <form id="form1" name="form1" method="post" action="Umodificacionservicio.php" onSubmit="return validar()">
...
?>
   ...
   <center>
     <input type="submit"  style="color: #FF0000" href="modificacionservicio.php" name="button" id="button" value="Modificar" >
