...
$vSql = "SELECT cl.apellido_cliente, cl.nombre_cliente, c.nro_cuota, c.fecha_vencimiento, c.importe, c.estado, c.saldo, c.idcuotas_clientes, c.id_prestacion, s.empresa, s.tipo_servicio 
...
<div id="tablaimprimir">
    <strong><h3>Listado de deudas</h3></strong> 
  

    <a href="buscardeudacliente.php"><input type="button"  name="button3" id="button3" value="Buscar Cliente"></a>
    </p><br>
