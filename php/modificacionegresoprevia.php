...
<div class="container-fluid">
  ...
  <hr>
  <form id="form1" name="form1" method="post" action="modificacionegreso.php" onSubmit="return validar()">
...
?>
 ...
 <strong><h3>Listado de egresos de caja</h3></strong> </p> <br>
...
?>
   ...
   <center>
     <input type="submit"  style="color: #FF0000"  href="modificacionegreso.php" name="button" id="button" value="Modificar" >
