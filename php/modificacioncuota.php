...
<div class="container-fluid">
  <div class="row">
  <center>
    <form id="form1" name="form1" method="post" action="modificarcuotaBD.php" onSubmit="return validacion()">
    <?php
include("conexion.inc");

$vf= $_POST['fi'];

$vSql = "SELECT nro_cuota, estado, importe, id_prestacion, fecha_vencimiento, idcuotas_clientes 
FROM  cuotas_clientes 
where $vf=idcuotas_clientes";
...
?>
      ...
      <p>
        ...
        <input name="Num" type="text" id="Num" value="<?php echo ($vResultado['nro_cuota']); ?>" >
        <label for="Importe">Importe:</label>
        <input name="Importe" type="text" id="Importe" value="<?php echo ($vResultado['importe']); ?>">
        <label for="textfield">Id Prestación:</label>
        <input type="text" name="id" id="id" value="<?php echo ($vResultado['id_prestacion']); ?>">
      </p>
      <p>&nbsp;</p>
      <p>
        ...
        <input name="FechaV" type="text" id="FechaV" value="<?php echo ($vResultado['fecha_vencimiento']); ?>" >
        ...
        <input  name="id_cc" type="hidden" id="id_cc" value="<?php echo ($vResultado['idcuotas_clientes']); ?>" >
      </p>
      <p>&nbsp;</p>
      <p>
        <input type="submit" href="modificarcuotaBD.php" name="button" id="button" value="Registrar">
