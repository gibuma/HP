...
location.href="mostrarpolizasxempresa.php";
}
...
<div id="tablaimprimir">
    <strong><h3>Listado de movimientos de poliza</h3></strong> </p>
     
    <a href="mostrarpolizasxmovimiento.php"><input type="button" name="button2" id="button2" value="Por Movimiento"></a>
    <a href="mostrarpolizasxapellido.php"><input type="button"  name="button3" id="button3" value="Por Persona"></a>
    <a href="mostrarpolizas.php"><input type="button" name="button2" id="button2" value="Por Entrada"></a>
     <br>
<br><br>
...
?>
       ...
       <td width="50px"><?php echo ($fila['apellido_cliente']); ?></td>
         ...
         <td width="50px"><?php echo ($fila['edificio_riesgo']); ?></td>
           ...
           <td><input type="button" style="color: #003366; background-color: #99CCFF" onclick="<?php echo "location.href='eliminarmovimientopoliza.php?id_m=".$fila['id_movimientopoliza']."'";?> , confirmarEliminar()" name="button" 
...
?>
  ...
  <a href="modificacionaltaprevia.php">  <input type="button"   name="button" id="button" value="Modificar Alta" ></a><br> <br>
  <a href="modificacionbajaprevia.php"> <input type="button"   name="button" id="button" value="Modificar Baja" ></a> <br> <br>
  <a href="../inicioAdministrador.php"><input type="button"  name="Salir" id="Salir" value="Salir"></a><br> <br>
