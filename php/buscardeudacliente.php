...
<div class="container-fluid">
  <div class="row">
   <center> <form id="form1" name="form1" method="post" action="mostrardeudascliente.php" onSubmit="return validacion()" >
  ...
  <?php while ($fila = mysqli_fetch_array($vResultado)) {
    echo "<option value='".$fila["id_cliente"]."'>".$fila['apellido_cliente']." ".$fila['nombre_cliente']."</option>"; 
      ...
      <p>&nbsp;</p>
      <p>
        <input type="submit" href="mostrardeudascliente.php" name="button" id="button" value="Buscar">
