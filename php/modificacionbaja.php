...
<div class="container-fluid">
  ...
  <center>
    <p>&nbsp;</p>
    <form id="form1" name="form1" method="post" action="modificarbajaBD.php" onSubmit="return validacion()">
          <?php
...
?>
      ...
      <p>
        ...
        <Select type="text" name="Estado" id="Estado">
          <option value="<?php echo ($vResultado['id_movimientopoliza']); ?>"><?php echo ($vResultado['estado']); ?></option>
      ...
      <p>&nbsp;</p>
      <p>
        <input type="submit" href="modificarbajaBD.php" name="button" id="button" value="Registrar">
