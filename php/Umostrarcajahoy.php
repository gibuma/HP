...
<div class="container-fluid">
  ...
  <hr>
  <form id="form1" name="form1" method="post" action="modificacioningresoprevia" >
...
where m.fecha_vencimiento=cuo.fecha_vencimiento and m.fecha= curdate() )
...
inner join cuentas_usuarios cu on mo.id_cuenta=cu.id_cuenta where mo.fecha= curdate())
...
<h3>Listado de movimientos de caja</h3> </p>
 <div id="tablaimprimir">
     <p><a href="Umostrarcajaxempresa.php">
      <input type="button" name="button2" id="button2" value="Por Empresa">
       </a>
       
       <a href="Umostrarcajaxpersona.php">
       <input type="button"  name="button3" id="button3" value="Por Persona">   </a>
        <a href="Umostrarcaja.php">
       <input type="button"  name="button3" id="button3" value="Todos">
...
<center>
    <br><br>
       <a href="Umodificacioningresoprevia.php">  <input type="button"   name="button" id="button" value="Ingresos" ></a>
  <a href="Umodificacionegresoprevia.php"> <input type="button"   name="button" id="button" value="Egresos" ></a>
...
<br><br>
 ...
 <a href="email.php"><input type="button" name="button" id="button" value="ENVIAR MAIL DIARIO" ></a>
</form>   </div>  </div>
</div>
