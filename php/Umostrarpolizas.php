...
<div id="tablaimprimir">
    ...
    <a href="Umostrarpolizasxapellido.php"><input type="button"  name="button3" id="button3" value="Por Persona"></a>
    <br> 
<br><br>
...
?>
  ...
  <a href="../inicioUsuario.php"><input type="button"  name="Salir" id="Salir" value="Salir"><br> <br>
  </a> <a href="javascript:imprSelec('tablaimprimir')"><input type="button" value="Imprimir"></a>
