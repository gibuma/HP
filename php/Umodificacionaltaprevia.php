...
?>
  <form id="form1" name="form1" method="post" action="Umodificacionalta.php" onSubmit="return validar()" >
...
<div style: text-align="center">
   <h3>Listado de altas de polizas</h3> </p>  <br>
...
?>
   ...
   <center>
     <input type="submit" style="color: #FF0000" href="Umodificacionalta.php" name="button" id="button" value="Modificar" >
