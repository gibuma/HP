...
location.href="mostrarpolizasxapellido.php";
}
...
<strong><h3>Listado de movimientos de poliza</h3></strong> </p>
     <a href="mostrarpolizasxempresa.php"><input type="button" name="button2" id="button2" value="Por Empresa"></a>
    <a href="mostrarpolizasxmovimiento.php"><input type="button" name="button2" id="button2" value="Por Movimiento"></a>
    <a href="mostrarpolizas.php"><input type="button"  name="button3" id="button3" value="Por Entrada"></a>
 <br>
<br><br>
