...
$vSql = "SELECT DISTINCT  cl.apellido_cliente, cl.nombre_cliente, cc.nro_cuota, cc.fecha_vencimiento, cc.importe, cc.estado, cc.saldo, cc.idcuotas_clientes, cc.id_prestacion, s.empresa, s.tipo_servicio 
...
where cc.estado='no paga' and cl.id_cliente='$vCliente'
order by cc.fecha_vencimiento desc";
$vResultado = mysqli_query($link, $vSql);
$vSql = "SELECT  sum(c.importe) as total
FROM  cuotas_clientes c 
inner join servicios s on c.id_prestacion=s.id_prestacion 
inner join clientes cl on s.id_cliente=cl.id_cliente 
where  c.estado='no paga' and cl.id_cliente='$vCliente'
order by c.fecha_vencimiento desc";
$vR = mysqli_query($link, $vSql);
$t = mysqli_fetch_array($vR);
...
<div id="tablaimprimir">
   <h3>Deuda</h3>
    ...
    <a href="Umostrardeudas.php"><input type="button"  name="button3" id="button3" value="Volver"></a>
     ...
     <table  border=1 bordercolor="#3BB3DD"  width="800"   margin: 0 auto >
      <center>
        <tr>
         ...
         <td width="50px"><b><center>Saldo</center></b></td>
...
mysqli_close($link);
?>
    </table></div> <br><font color="red"> Total=<?php echo ($t['total']); ?></font><br><br>    
  
		    
		 
   <center><a href="../inicioAdministrador.php">
