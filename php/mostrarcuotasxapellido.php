...
location.href="mostrarcuotasxapellido.php";
}
...
<div class="container-fluid">
  ...
  <hr>
  <form id="form1" name="form1" method="post" action="modificacioncuota.php" onSubmit="return validar()">
...
order by cl.apellido_cliente ,cc.fecha_vencimiento desc";
...
<div id="tablaimprimir">
    ...
    <strong><h3>Listado de cuotas</h3></strong> 

  <a href="mostrarcuotasxempresa.php"><input type="button" name="button2" id="button2" value="Por Empresa"></a>
    <a href="mostrarcuotasxestado.php"><input type="button" name="button2" id="button2" value="Por Estado"></a>
    <a href="mostrarcuotas.php"><input type="button"  name="button3" id="button3" value="Por Vencimiento"></a>
    </p><br>
         ...
         <td width="50px"><b><center>Importe</center></b></td>
          ...
          <td width="50px"><b><center>Apellido</center></b></td>
            <td width="50px"><b><center>Nombre</center></b></td>
             ...
             <td><b><font color="red">Selección Modificar</font></b></td>
        </tr>
        <?php
...
?>
        <tr>
         ...
         <td width="50px"><input type="radio" name="fi" id="fi" value="<?php echo $fila['idcuotas_clientes']; ?>"></td>
           <td width="50px"><input type="button" style="color: #003366; background-color: #99CCFF" onclick="<?php echo "location.href='eliminarcuota.php?id_cc=".$fila['idcuotas_clientes']."'";?>, confirmarEliminar()" name="button" 
...
?>
   ...
   <center>
   <input type="submit" style="color: #FF0000" href="modificacioncuota.php" name="button" id="button" value="Modificar" >
