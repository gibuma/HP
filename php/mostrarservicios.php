...
<div class="container-fluid">
  ...
  <hr>
  <form id="form1" name="form1" method="post" action="modificacionservicio.php" onSubmit="return validar()">
...
$vSql = "SELECT distinct apellido_cliente, nombre_cliente, ramo, plan, forma_pago, s.id_prestacion, empresa, tipo_servicio,
 idservicios_clientes 
FROM servicios as s inner join clientes as c on s.id_cliente=c.id_cliente 
inner join servicios_clientes as sc on sc.id_cliente=c.id_cliente and s.id_prestacion=sc.id_prestacion
 order by apellido_cliente, empresa asc";
...
<div id="tablaimprimir">
    <strong><h3>Listado de servicios</h3></strong> </p><br>
...
?>
        <tr>
         ...
         <td width="50px"><?php echo ($fila['empresa']); ?></td>
          ...
          <td width="50px"><?php echo ($fila['forma_pago']); ?></td>
            
           <td><input type="radio" name="fi" id="fi" value="<?php echo $fila['idservicios_clientes']; ?>"></td>
           <td><input type="button" style="color: #003366; background-color: #99CCFF" onclick="<?php echo "location.href='eliminarservicio.php?id_ser=".$fila['idservicios_clientes']."'";?>, confirmarEliminar()" name="button" 
...
?>
   ...
   <center>
     <input type="submit" href="modificacionservicio.php" 
    style="color: #FF0000" name="button" id="button" value="Modificar" >
     <a href="../inicioAdministrador.php">
