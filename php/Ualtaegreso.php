...
<div class="container-fluid">
  <div class="row">
   <center> <form id="form1" name="form1" method="post" action="altaegresoBD.php" onsubmit="return validacion()">
  ...
  <?php while ($fila = mysqli_fetch_array($vResultado)) {
    echo "<option value='".$fila["id_cuenta"]."'>".$fila['apellido_cuenta']." ".$fila['nombre_cuenta']."</option>"; 
        ...
        <label for="textfield7">Forma egreso:</label>
        <select name="Forma" type="text" id="Forma" >
      ...
      <p>&nbsp;</p>
      <p>
        <input type="submit" href="altaegresoBD.php" name="button" id="button" value="Registrar">
