...
<div class="container-fluid">
  ...
  <hr>
  <form id="form1" name="form1" method="post" action="modificacioningreso.php" onSubmit="return validar()">
...
?>
 ...
 <strong><h3>Listado de ingresos de caja</h3></strong> </p> <br>
          ...
          <td width="50px"><?php echo ($fila['motivo']); ?></td>
           <td width="50px"><?php echo ($fila['observacion']); ?></td>
                ...
                <td width="50px"><?php echo ($fila['forma_movimiento']); ?></td>
                 ...
                 <td width="50px"><input type="radio" name="fi" id="fi" value="<?php echo $fila['id_movimientocaja']; ?>"></td>
...
?>
   ...
   <center>
     <input type="submit"  style="color: #FF0000"   href="modificacioningreso.php" name="button" id="button" value="Modificar" >
