...
?>
  <form id="form1" name="form1" method="post" action="modificacionalta.php" onSubmit="return validar()">
...
<div style: text-align="center">
  <strong><h3>Listado de altas de polizas</h3></strong> </p><br>
      ...
      <center>
        <tr>
          ...
          <td width="50px"><b><center>Asegurado</center></b></td>
             ...
             <td width="50px"><b><center><b>Edificio Riesgo</center></b></td>
...
?>
     ...
     <td width="50px"><input type="radio" name="fi" id="fi" value="<?php echo $fila['id_movimientopoliza']; ?>"></td>
...
?>
   ...
   <center>
     <input type="submit" style="color: #FF0000" href="modificacionalta.php" name="button" id="button" value="Modificar" >
