...
?>
  <form id="form1" name="form1" method="post" action="modificacionbaja.php" onSubmit="return validar()">
...
<div class="col-md-offset-2 col-md-8">
 ...
 <strong><h3>Listado de bajas de polizas</h3></strong> </p><br>
...
?>
   ...
   <center>
     <input type="submit" style="color: #FF0000" href="modificacionbaja.php" name="button" id="button" value="Modificar" >
