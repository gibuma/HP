...
location.href="mostrarcuotasxempresa.php";
}
...
order by s.empresa ,cc.fecha_vencimiento desc";
...
<div id="tablaimprimir">
    ...
    <a href="mostrarcuotasxapellido.php"><input type="button"  name="button3" id="button3" value="Por Cliente"></a>
