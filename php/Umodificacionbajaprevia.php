...
?>
  <form id="form1" name="form1" method="post" action="Umodificacionbaja.php" onSubmit="return validar()">
...
<div style: text-align="center">
 <h3>Listado de bajas de polizas</h3> </p>
 <div id="tablaimprimir"><br>
...
?>
   ...
   <center>
     <input type="submit" style="color: #FF0000" href="Umodificacionbaja.php" name="button" id="button" value="Modificar" >
