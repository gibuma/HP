...
inner join cuotas_clientes cuo on m.idcuotas_clientes=cuo.idcuotas_clientes 
where m.fecha_vencimiento=cuo.fecha_vencimiento and m.id_prestacion=cuo.id_prestacion )
 ...
 <div id="tablaimprimir">
     ...
     <p><a href="Umostrarcajaxempresa.php">
      <input type="button" name="button2" id="button2" value="Por Empresa">
       ...
       <input type="button"  name="button3" id="button3" value="Por Persona">
        <a href="Umostrarcajahoy.php">
       <input type="button"  name="button3" id="button3" value="Hoy">
