    ...
    <div class="collapse navbar-collapse" id="defaultNavbar1">
      ...
      <ul class="nav navbar-nav">
          ...
          <ul class="dropdown-menu" role="menu">
            <li><a href="registrarnuevocliente.php">Registrar Nuevo</a></li>
            <li><a href="php/mostrarclientes.php">Mostrar</a></li>
            <li><a href="#">Servicios</a></li> 
            	<ul>
                      				  <li><a href="php/altaservicios.php">Registrar</a>
                      <li><a href="php/mostrarservicios.php">Mostrar</a>                                          
                </ul>                  
                      </ul>
         <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Cuotas<span class="caret"></span></a>
          <ul class="dropdown-menu" role="menu">
            <li><a href="php/altacuota.php">Registrar</a></li>
            <li><a href="php/mostrarcuotas.php">Mostrar</a></li>
                      </ul>
         <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Caja<span class="caret"></span></a>
          <ul class="dropdown-menu" role="menu">
            <li><a href="php/altaegreso.php">Registrar Egreso</a></li>
            <li><a href="php/altaingreso.php">Registrar Ingreso</a></li>
            <li><a href="php/mostrarcaja.php">Mostrar</a></li>
            <li><a href="php/mostrardeudas.php">Deudas</a></li>
                          <li><a href="php/modificarsaldoscaja.php">Modificar Saldos</a></li>  
                                 </ul>
         <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Pólizas<span class="caret"></span></a>
          <ul class="dropdown-menu" role="menu">
            <li><a href="php/altaalta.php">Alta</a></li>
            <li><a href="php/altabaja.php">Baja</a></li>
            <li><a href="php/mostrarpolizas.php">Mostrar</a></li>                   
		</li>
        </ul>
        <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Cuentas<span class="caret"></span></a>
          <ul class="dropdown-menu" role="menu">
            <li><a href="registrarcuenta.php">Registrar</a></li>
            <li><a href="php/mostrarcuentas.php">Mostrar</a></li>
  <li><a href="php/mostrarlogueos.php">Mostrar Logueos</a></li>           
		</li>
        </ul>
      </ul>         
       </ul>    
